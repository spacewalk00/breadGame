...
---------화면에 배치------
	...
	for i = 1, #Data do
			...
			questBox[i].x, questBox[i].y = display.contentWidth/2, display.contentHeight*0.25 + 700*(i-1)
			--제목 파랑
...
-------------업적 달성 시----------
	...
	questGroup:addEventListener("touch", scroll)
end
